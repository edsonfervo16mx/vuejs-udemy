const app = new Vue({
    ...
    methods: {
        alta(){
            ...
            .then( res =>{
                ...
                if (res.data == 'success') {
                    ...
                    swal('El post no pudo se guardado');
                }
            })
        },
        getId(){
            ...
            if (uri.length == 2) {
                ...
                axios.get('http://localhost/projects/vuejs-udemy/snippets/api/crud/getId.php?id='+this.itemId.id)
                .then(res =>{
        ...
        eliminar(id){
            ...
            .then((aceptar)=>{
                if(aceptar){
                    axios.get('http://localhost/projects/vuejs-udemy/snippets/api/crud/eliminar.php?id='+ id)
                        .then(res =>{
                           if (res.data = 'success') {
                               this.getCategoria()
                               swal('post eliminado');
        ...
        getUser(){
            axios.get('http://localhost/projects/vuejs-udemy/snippets/api/crud/getUser.php')
                .then(res =>{
        ...
        getCategoria(){
            ...
            if (uri.length == 2) {
                ...
                this.itemId = getVars
                console.log(this.itemId.id)
                axios.get('http://localhost/projects/vuejs-udemy/snippets/api/crud/getCategoria.php?cat='+this.itemId.cat)
                .then(res =>{
                    this.listar = res.data
                })
            }else{
                axios.get('http://localhost/projects/vuejs-udemy/snippets/api/crud/getPost.php')
                .then(res =>{
                    this.listar = res.data;
                })
            }
